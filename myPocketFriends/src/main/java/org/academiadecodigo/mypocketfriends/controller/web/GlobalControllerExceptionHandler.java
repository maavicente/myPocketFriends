...
public class GlobalControllerExceptionHandler {
    ...
    @ExceptionHandler(value = PocketFriendsException.class)
    public ModelAndView handleClientErrors(HttpServletRequest req, PocketFriendsException ex) {
    ...
    private void logException(Exception ex) {
        String errorOrigin = ex instanceof PocketFriendException ? "Client" : "Server";
